  ...
  return (
    <div className="mt-16" id="skills">
      <div className="flex flex-col gap-5">
        ...
        <div className="flex p-4 flex-col md:p-20 lg:flex-row justify-around items-center place-content-center ">
          <motion.div
          ...
          >
            <p className="text-white text-justify  md:text-justify  text-md font-semibold">
          ...
          <motion.div
            className="hidden md:flex flex-col mt-3 w-full sm:w-[80%] md:w-[60%] lg:w-[50%] gap-5 items-center"
            initial={{ opacity: 0, x: -100 }}
            animate={
              isInViewport ? { opacity: 1, x: 0 } : { opacity: 0, x: -100 }
            }
